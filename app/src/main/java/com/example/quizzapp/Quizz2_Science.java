...
public class Quizz2_Science extends AppCompatActivity implements View.OnClickListener {
    ...
    public static String choises[][] = {
            ...
            {"Photosynthesis", "Respiration", "Fermentation", "Oxidation"},
    };
    ...
    Button submitBtn;
    int score = 0;
    int totalQuest = Quizz2_Science.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        withoutBar();
        setContentView(R.layout.activity_quizz2_science);
        initComponents();
        loadNewQuestion();
    ...
    private void loadNewQuestion() {
        ...
        questionTextView.setText(Quizz2_Science.question[currentQuestionIndex]);
        ans_A.setText(Quizz2_Science.choises[currentQuestionIndex][0]);
        ans_B.setText(Quizz2_Science.choises[currentQuestionIndex][1]);
        ans_C.setText(Quizz2_Science.choises[currentQuestionIndex][2]);
        ans_D.setText(Quizz2_Science.choises[currentQuestionIndex][3]);
    ...
    public void onClick(View v) {
        ...
        if(clickedButon.getId() == R.id.submit_btn){
            if(selectedAnswer.equals(Quizz2_Science.correctAnswers[currentQuestionIndex])){
                score++;
            }
